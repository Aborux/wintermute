...
set(WINTER_CMAKE_DATA_DIR              "${WINTER_CMAKE_DIR}/data"                     CACHE PATH "Path to directory for CMake-related for Wintermute. (needed?)")
...
set(WINTER_IS_PLUGIN                   OFF) # Needed?

set(WINTERMUTE_COMPILE_DEFINITIONS		"WINTERMUTE;"                 				  CACHE STRING "Compile definitions for Wintermute.")
set(WINTERMUTE_COMPILE_FLAGS       		"-std=c++0x -Wabi -Wall -Wextra -ggdb -Wctor-dtor-privacy -Wformat -Wunused -O2"
                                                                                      CACHE STRING "Compilation flags to be used with Wintermute.")
